...
function App() 
{
  ...
  const handleImageGenerate = async () => {
    try 
    {
      const response = await axios.post("http://127.0.0.1:8000/image", {prompt: imagePrompt,});
    ...
    catch (error) 
    {
      ...
      setImage("Image generation failed");
    }
  };
    ...
    <div style={{ padding: 40, fontFamily: "Arial" }}>
      ...
      {image && (
        <div style={{ marginTop: 20 }}>
          <img src={image} alt="Generated" style={{ width: 300 }} />
        </div>
      )}
